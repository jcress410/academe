...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_175958540 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#tutorials\np3\ns.')
    _attrs_175937388 = _loads('(dp1\n.')
    _attrs_175936588 = _loads('(dp1\nVsrc\np2\nV${request.application_url}/static/logo.png\np3\nsVwidth\np4\nV300\np5\nsVheight\np6\nV80\np7\ns.')
    _attrs_175914732 = _loads('(dp1\nVid\np2\nVwrap\np3\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_175939084 = _loads('(dp1\nVtype\np2\nVsubmit\np3\nsVid\np4\nVx\nsVvalue\np5\nVSearch\np6\ns.')
    _attrs_175939500 = _loads('(dp1\n.')
    _attrs_175938700 = _loads('(dp1\nVid\np2\nVright\np3\nsVclass\np4\nValign-left\np5\ns.')
    _attrs_175936492 = _loads('(dp1\nVid\np2\nVbottom\np3\ns.')
    _attrs_175913324 = _loads('(dp1\nVcontent\np2\nVtext/html;charset=UTF-8\np3\nsVhttp-equiv\np4\nVContent-Type\np5\ns.')
    _attrs_175959436 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#sample-applications\np3\ns.')
    _attrs_175957196 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/\np3\ns.')
    _attrs_175956684 = _loads('(dp1\nVhref\np2\nVhttp://pylonshq.com\np3\ns.')
    _attrs_175935820 = _loads('(dp1\nVclass\np2\nVheader\np3\ns.')
    _attrs_175959180 = _loads('(dp1\n.')
    _attrs_175913708 = _loads('(dp1\nVcontent\np2\nVpyramid web application\np3\nsVname\np4\nVdescription\np5\ns.')
    _attrs_175981132 = _loads('(dp1\nVclass\np2\nVfooter\np3\ns.')
    _attrs_175938508 = _loads('(dp1\nVaction\np2\nVhttp://docs.pylonshq.com/pyramid/dev/search.html\np3\nsVmethod\np4\nVget\np5\ns.')
    _attrs_175914988 = _loads('(dp1\nVid\np2\nVheader\np3\ns.')
    _attrs_175956140 = _loads('(dp1\nVclass\np2\nVlinks\np3\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_175936844 = _loads('(dp1\nVclass\np2\nVapp-welcome\np3\ns.')
    _attrs_175956940 = _loads('(dp1\n.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_175937708 = _loads('(dp1\nVid\np2\nVfooter\np3\ns.')
    _attrs_175914092 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nV${request.application_url}/static/pylons.css\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_175958092 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#api-documentation\np3\ns.')
    _attrs_175938284 = _loads('(dp1\n.')
    _attrs_175938028 = _loads('(dp1\nVid\np2\nVleft\np3\nsVclass\np4\nValign-right\np5\ns.')
    _attrs_175936300 = _loads('(dp1\nVclass\np2\nVtop align-center\np3\ns.')
    _attrs_175957388 = _loads('(dp1\n.')
    _attrs_175937132 = _loads('(dp1\nVclass\np2\nVapp-name\np3\ns.')
    _attrs_175913900 = _loads('(dp1\nVhref\np2\nV${request.application_url}/static/favicon.ico\np3\nsVrel\np4\nVshortcut icon\np5\ns.')
    _attrs_175937772 = _loads('(dp1\nVclass\np2\nVbottom\np3\ns.')
    _attrs_175914284 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nVhttp://fonts.googleapis.com/css?family=Nobile:regular,italic,bold,bolditalic&subset=latin\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_175959628 = _loads('(dp1\n.')
    _attrs_175913516 = _loads('(dp1\nVcontent\np2\nVpython web application\np3\nsVname\np4\nVkeywords\np5\ns.')
    _attrs_175938796 = _loads('(dp1\nVname\np2\nVq\nsVvalue\np3\nV\nsVtype\np4\nVtext\np5\nsVid\np6\nVq\ns.')
    _attrs_175958732 = _loads('(dp1\n.')
    _attrs_175959884 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#support-and-development\np3\ns.')
    _attrs_175936044 = _loads('(dp1\nVid\np2\nVtop\np3\ns.')
    _attrs_175958284 = _loads('(dp1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_175912620 = _loads('(dp1\nVxml:lang\np2\nVen\np3\nsVxmlns\np4\nVhttp://www.w3.org/1999/xhtml\np5\ns.')
    _attrs_175913004 = _loads('(dp1\n.')
    _attrs_175957836 = _loads('(dp1\n.')
    _attrs_175980588 = _loads('(dp1\n.')
    _attrs_175956396 = _loads('(dp1\n.')
    _attrs_175980844 = _loads('(dp1\nVhref\np2\nVirc://irc.freenode.net#pyramid\np3\ns.')
    _attrs_175913100 = _loads('(dp1\n.')
    _attrs_175957644 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#narrative-documentation\np3\ns.')
    _attrs_175912844 = _loads('(dp1\n.')
    _attrs_175958988 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#change-history\np3\ns.')
    def render(econtext, rcontext=None):
        ...
        attrs = _attrs_175936844
        _write(u'<p class="app-welcome">\n\t\t\t\t\tWelcome to ')
        attrs = _attrs_175937132
        u'project'
